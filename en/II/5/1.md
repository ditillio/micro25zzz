...
To convince ourselves of this, let us assume for a moment that the monopolist can only produce output in multiples of 500 units. Let us assume that the market demand is $Q=5000-1000P$, or equivalently $P=5-Q/1000$. The monopolist's revenue and marginal revenue are then those indicated in the following table:
...
<style>
  ...
  <table class="monrev" style="width:30%; table-layout:auto;">
    <tr>
      ...
      <th style="width:10%"> Marginal Revenue </th>
    </tr>
...
As can be seen from the third column of the table, revenue initially increases, then decreases, as quantity increases (it indeed has the shape of an inverted U), while marginal revenue (fourth column) is decreasing. Thinking about it for a moment, this should not surprise us: <i>the monopolist's revenue is nothing but the consumers' expenditure!</i> When quantity is low and price is high, we are in the upper part (the elastic part) of the demand curve. In contrast, when quantity is high and  price is low, we are in the lower part (the inelastic part) of the demand curve. Now, let us illustrate revenue and marginal revenue in the case where the monopolist can produce any quantity.
