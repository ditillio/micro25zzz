...
Concludiamo questa sezione con un'osservazione che ci tornerà utile più avanti, in particolare nel <a href="{{ site.baseurl }}/it/V/13">Capitolo 13</a>. Per un individuo con funzione di utilità concava (cioè avverso al rischio), vale una proprietà
<span class="marginnote">
...
<ul>
	<li>
		a parità di payoff atteso, un individuo avverso al rischio preferisce lotterie meno variabili: tra due alternative con lo stesso payoff atteso, sceglierà quella con minore <i>variabilità</i>, cioè quella in cui i payoff possibili sono più vicini alla loro media. 
	</li>
</ul>
Questa proprietà può essere formulata equivalentemente così:
<ul>
	<li>
		a parità di <i>utilità</i> attesa, se una lotteria è resa più variabile, allora l’individuo richiederà un valore atteso più alto per accettarla. In altre parole, maggiore rischio deve essere compensato con maggiore payoff atteso.
	</li>
</ul>

llustriamo questo principio nella figura seguente. Un individuo con funzione di utilità della moneta $u(W)=\sqrt{W}$, ovvero con $\pi=0.5$, fronteggia una lotteria che ha due payoff possibili ed equiprobabili, $W_1$ e $W_2$. Al variare del valore selezionato di $W_1$, la figura calcola automaticamente il valore di $W_2$ in modo da mantenere il payoff atteso o l'utilità attesa costante.
